...
${user.sex === Sex.FEMALE ? 'рада' : 'рад'}, что у Soundcheck появилась рассылка!`,
      ...
      `Вжух… и новые релизы от Soundcheck в твоих сообщениях.`,
...
Soundfest American Style. Весь вечер на сцене Blues Bastards, Nuggers, Jack Jack. Покупай билеты онлайн, на входе будет дороже!`,
...
в космосе Уральской музыки. Переходи в товары и смотри, как она выглядит!`,
  ...
  enter_message_post: 'Отправьте запись (чтобы пропустить, отправьте "нет")',

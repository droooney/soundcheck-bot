...
export const captions = {
  // main menu
  welcome_text: (user: User) => `Привет, ${user.firstName}. Ты активировал чат-бота Soundcheck. Тебе нужно всего лишь нажать на одну из кнопок внизу экрана, \
и ты получишь доступ ко множеству материалов нашего паблика. Также ты можешь написать нам или заказать одну из услуг проекта, \
будь то пост, реклама или дизайн стикеров для музыкантов.`,
  ...
  back_to_main_menu: [
    'Ты вернулся в Главное меню. Куда отправимся дальше?',
    'Ты вернулся в Главное меню. Не забывай, что ты всегда можешь поддержать нас лайком, отзывом или монетой.',
    'И снова Главное меню… а ты любопытный.',
    'Главное меню – это начало нового пути.',
    'Ты снова перешел в Главное меню. Пойдем за новым материалом?',
    'Главное меню. Если бы количество лайков равнялось количеству переходов в главное меню, мы бы давно догнали МДК.',
    ({ buttonsCount }: BackToMainMenuCaptionOptions) => `Главное меню. Есть ${buttonsCount} кнопок, на какие сам тапнешь, какие другу отправишь?`,
    'Ты вернулся в Главное меню. Уже все прочитал?',
  ...
  back_to_poster: [
    'Ты вернулся к выбору Афиши. Как хорошо, что у каждого формата есть свои преимущества.',
    'Ты вернулся к выбору Афиши. Нам нравится твой подход. Концерт – дело серьезное.',
    'Снова меню выбора формата Афиши. Если тебе что-то понравится, не поскупись на лайки, нас это очень поддерживает.',
    'Ты вернулся к выбору формата Афиши. Да, выбор концерта – дело непростое.',
